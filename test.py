...
def main():
    ...
    parser.add_argument('--test_set', default='natural')
    ...
    for model_path in model_paths:
        ...
        if args.test_set=='natural':
            test_set = SceneTextDataModule.TEST_BENCHMARK_SUB
        elif args.test_set=='other':
            test_set = SceneTextDataModule.TEST_UW
        ...
        if args.test_set=='natural':
            result_groups = {
                'Natural Scene': SceneTextDataModule.TEST_BENCHMARK_SUB
            }
        elif args.test_set=='other':
            result_groups = {
                'Natural Scene': SceneTextDataModule.TEST_UW
            }
